...
def dnspoisoned():
    ...
    for dom in domdom:
        ...
        try:
            ...
            res['Yunnan Province'])
            sql = "INSERT INTO dnschecker_dnschecker(domain,expectedresponse,beijing,shenzhen,inner_mongolia,heilongjiang_province,yunnan_province) VALUES(%s, %s, %s, %s, %s, %s, %s)"
            ...
            val = (
                domstr, 'blocked', 'blocked', 'blocked', 'blocked', 'blocked', 'blocked')
            sql = "INSERT INTO dnschecker_dnschecker(domain,expectedresponse,beijing,shenzhen,inner_mongolia,heilongjiang_province,yunnan_province) VALUES(%s, %s, %s, %s, %s, %s, %s)"
            mycursor.execute(sql, val)
